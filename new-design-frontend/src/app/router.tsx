...
function RouteFallback() {
  return (
    <div className="flex min-h-[280px] items-center justify-center gap-3 rounded-3xl border border-border bg-card p-8 shadow-premium">
      <LoaderCircle className="animate-spin text-primary" size={22} aria-hidden />
      <span className="text-sm font-semibold text-text-secondary">Sahifa yuklanmoqda…</span>
    </div>
  );
}
      ...
      <Routes>
        ...
        <Route element={<ProtectedRoute />}>
          ...
          <Route element={<AppShell />}>
            ...
            <Route path="/retake/dashboard" element={<RetakeDashboard user={null as any} />} />
